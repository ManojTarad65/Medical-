...
export default function ContactUs() {
  ...
  return (
    <div className="mt-16 min-h-screen flex flex-col justify-center items-center px-4 md:px-12 bg-gray-900 text-white w-full   ">
      {/* Contact Section */}
        ...
        <div className="w-full md:w-1/2 p-8 bg-gradient-to-br from-blue-600 to-purple-600 text-white flex flex-col justify-center">
          ...
          <div className="mt-6 space-y-6 ">
            <div className="flex items-center space-x-4">
              <Mail size={28} />
              <p className="text-lg">jaiparkashrankawat2@gmail.com</p>
            </div>
            <div className="flex items-center space-x-4">
              <Phone size={28} />
